"""
Django settings for green_snow_dev_81606 project.
...
ROOT_URLCONF = 'green_snow_dev_81606.urls'
...
WSGI_APPLICATION = 'green_snow_dev_81606.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "green_snow_dev_81606 API",
    "DESCRIPTION": "API documentation for green_snow_dev_81606 App",
    "VERSION": "v1",
}
